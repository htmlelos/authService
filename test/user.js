...
describe('Pruebas de Usuarios', () => {
    ...
    describe('GET /user/:userId/roles', () => {
        it('deberia obtener un arreglo vacio si no hay roles asignados', done => {
            let user = new User({
                username: 'guest@mail.com',
                password: 'guest',
                status: 'ACTIVO'
        ...
        it('deberia obtener los roles del usuario por su id', done => {
            let user = new User({
                username: 'guest@mail.com',
                password: 'guest',
                status: 'ACTIVO'
    ...
    describe('POST /user/:userId/role', () => {
      it('no deberia agregar un rol invalido a un usuario', done => {
